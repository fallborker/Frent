...
<div style="display: flex">
    <div style="width: 90%">
        ...
        <p>In addition, all destroyers are called when a world is disposed of. Try removing the <code>e.Delete()</code> line on the right, and the <code>using</code> statement will implicitly call the destroyer.</p>
    </div>
